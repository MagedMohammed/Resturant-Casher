    ...
    <div class="row">
        <div class="left col-md-8">
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="<?php echo'#'.$group['id']; ?>"><h5><?php echo $group['groupName']; ?></h5></a></li>
                <?php  endforeach; ?>
                <form action="index.php" method="get" class="form-groub" >
                    <div class="tab-content clear-fix">
                    <?php foreach($groups as $group):?>
                    <div class="row tab-pane fade " id="<?php echo $group['id']; ?>">

                   <?php $query2 = $conction -> prepare("SELECT * FROM items WHERE group_id=?");
            ...
            <!-- iteam start-->
                        <div class=" item col-sm-4 col-md-2"  >
                            <h4 align="center" class="h4 itemName"><?php echo $item["item_name"];?></h4>
...
<?php  endforeach; ?>
    ...
    <!-- End tabs-->
        ...
        <center>
            ...
            <button onclick="window.location.href='print.php'";>print</button>            
            <hr>
            <div class="prices">
                <p class="h4">Resturent Cachier</p>
            <table dir="rtl" name="magid" id="res" class="table table-condensed">
                    <tr>
                        <th>الصنف</th>
                        <th>العدد</th>
                        <th>السعر</th>
